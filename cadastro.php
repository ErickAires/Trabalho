        ...
        <div class="container">
            ...
            <?php
                ...
                <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
                    <h4 class="text-secondary mb-3">Vai de férias?</h4>
                    <h1 class="display-4 mb-4">Reserve  <span class="text-primary">Para seu Pet</span></h1>
                    <p>Vai sair de férias ou uma viagem inesperada? Reserve sua hospedagem e garanta o conforto do seu Pet.</p>
                    <div class="row py-2">
                        <div class="col-sm-6">
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center mb-2">
                                    <h1 class="flaticon-house font-weight-normal text-secondary m-0 mr-3"></h1>
                                    <h5 class="text-truncate m-0">Hospedagem</h5>
                                </div>
                                <p>Deixe seu amigo de quatro patas em um ambiente seguro e acolhedor</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex flex-column">
                                ...
                                <p>Com uma alimentação balanceada e de qualidade, seu pet estará sempre saudável e bem nutrido</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <h5 class="text-truncate m-0">Banho e Tosa</h5>
                                </div>
                                <p class="m-0">Proporcione ao seu pet uma experiência de cuidado completa</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <h5 class="text-truncate m-0">Treinamento</h5>
                                </div>
                                <p class="m-0">Com métodos eficientes e carinho, oferecemos adestramento personalizado</p>
                            </div>
                        </div>
                    </div>
                </div>
