...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="price.html" class="nav-item nav-link">Planos</a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block">Melhores Serviços</h3>
                            <h1 class="display-3 text-white mb-3">Hospedagem & Treino</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block">Oferecemos um ambiente acolhedor e seguro para a hospedagem do seu pet, com programas de treino personalizados para garantir que ele se sinta confortável e bem comportado</h5> 
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block">Melhores Serviços</h3>
                            <h1 class="display-3 text-white mb-3">Banho & Tosa</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block">Proporcione ao seu pet uma experiência de cuidado completa com nossos serviços de banho e tosa, realizados por profissionais qualificados para garantir que ele fique limpo e sempre bonito.</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container pt-5">
        <div class="d-flex flex-column text-center mb-5">
            <h4 class="text-secondary mb-3">Blog de Animais</h4>
            <h1 class="display-4 m-0"><span class="text-primary">Atualizações</span> do Blog</h1>
        </div>
        <div class="row pb-3">
            <div class="col-lg-4 mb-4">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 mb-2">
                    ...
                    <div class="card-body bg-light p-4">
                        ...
                        <p>Diam amet eos at no eos sit lorem, amet rebum ipsum clita stet, diam sea est diam eos, rebum sit vero stet justo</p>
                        <a class="font-weight-bold" href="">Leia mais</a>
                    </div>
                </div>
            </div>
        </div>
